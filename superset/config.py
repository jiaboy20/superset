...
DEFAULT_FEATURE_FLAGS: dict[str, bool] = {
    ...
    # Enables telemetry using Scarf.sh (to help measure Superset's adoption and the impact security concerns or other issues might have on the community)
...
TALISMAN_CONFIG = {
    "content_security_policy": {
        "default-src": ["'self'"],
        "img-src": ["'self'", "blob:", "data:", "https://apachesuperset.gateway.scarf.sh"],
